import todoList from '@devdocs/fakedb/apps/todo/todoList';
import folderList from '@devdocs/fakedb/apps/todo/folderList';
import { staffList } from '@devdocs/fakedb/apps/todo/staffList';
import priorityList from '@devdocs/fakedb/apps/todo/priorityList';
import { labelList } from '@devdocs/fakedb/apps/todo/labelList';
