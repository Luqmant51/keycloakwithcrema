import mailData from '@devdocs/fakedb/apps/mail/mailList';
import folderList from '@devdocs/fakedb/apps/mail/folderList';
import labelList from '@devdocs/fakedb/apps/mail/labelList';
