import contactData from '@devdocs/fakedb/apps/contact/contactList';
import labelList from '@devdocs/fakedb/apps/contact/labelList';
import { NextRequest } from 'next/server';
import { ContactObjType, LabelType } from '@devdocs/types/models/apps/Contact';
