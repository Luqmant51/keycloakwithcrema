import connectionList from '@devdocs/fakedb/apps/chat/connectionList';
import chatList from '@devdocs/fakedb/apps/chat/chatList';
import { NextRequest } from 'next/server';
import { ConnectionType, MessageObjType } from '@devdocs/types/models/apps/Chat';
