...
import MediaViewer from '@devdocs/components/AppMediaViewer';
import { orange } from '@mui/material/colors';
import { alpha } from '@mui/material';
import { Fonts } from '@devdocs/constants/AppEnums';
import Image from 'next/image';

import { getFileSize } from '@devdocs/helpers/Common';
import { styled } from '@mui/material/styles';
import {
  MediaType,
  MessageDataType,
  MessageType,
} from '@devdocs/types/models/apps/Chat';
import { AuthUserType } from '@devdocs/types/models/AuthUser';
